	...
	public static void main(String[] args) {
		...
		while(!quit) {
			...
			case 0:
				...
				break;
			case 1:
				groceryList.printGroceryList();  //System.out.println("Printing grocery items"); 
				break;
			case 2:
				addItem();                       // System.out.println("Adding items in the list");
				break;
			case 3:
				modifyItem();                    //System.out.println("Modifying item in the list"); 
				break;
			case 4 :
				removeItem();                    //System.out.println("Removing item from list"); 
				break;
			case 5 :
				searchItem();                    //System.out.println("Searching item in the list"); 
				break;                               
			case 6 :
				quit=true;
				break;
