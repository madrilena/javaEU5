...
public class ArrayClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(languages));//first it takes num, than capital one and small letter.
		
		//binarySearch()
		int[] numX = {4,6,7,10,55};
		System.out.println(Arrays.binarySearch(numX, 7 )); //2 give index num.
		System.out.println(Arrays.binarySearch(numX, 55 ));
		System.out.println(Arrays.binarySearch(numX, 5 )); //(-2(insertionPoint)-1) (-1-1=-2)
