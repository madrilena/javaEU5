...
public class task93_HowManyWords {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr.length);   //top.sayi
	    System.out.println(Arrays.toString(arr));   //Virgulle ayrilmis hali
	    System.out.println(arr[72]);   //72.
	    
		for(String value:arr) {
			System.out.println(value); //tek tek kel.
		}
